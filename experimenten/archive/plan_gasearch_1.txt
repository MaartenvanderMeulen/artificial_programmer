...
================================== 15 October local search in mut en cx, pop 300 ====================================================

Solving problems, layer 1 ...
problem get_col ...
problem get_col solved after 680 evaluations by (function get_col (board col) (for board board (at board col)))
problem get_diag1 ...
problem get_diag1 solved after 12766 evaluations by (function get_diag1 (board) (for i (len board) (at board i i)))
problem get_diag2 ...
problem get_diag2 solved after 46010 evaluations by (function get_diag2 (board) (for i 3 (sub (at board i (sub 2 i)) (at (for i 3 2) 2 (for (at 3 3 board) (sub i i) (for board board board))))))
problem get_magic_number_n ...
problem get_magic_number_n solved after 79844 evaluations by (function get_magic_number_n (n) (add (div (mul (mul 1 n) (mul n (mul n n))) (add n (mul 1 n))) (div (add 1 n) (div 2 1))))
problem are_all_equal_to ...
problem are_all_equal_to solved after 2044 evaluations by (function are_all_equal_to (values x) (eq values (for (len values) (for values values x) values)))

Solving problems, layer 2 ...
problem get_row_sums ...
problem get_row_sums solved after 51 evaluations by (function get_row_sums (board) (for row board (sum (for board row board))))
problem get_col_sums ...
problem get_col_sums solved after 21716 evaluations by (function get_col_sums (board) (for i 3 (sum (get_col board i))))
problem get_diag_sums ...
problem get_diag_sums solved after 418 evaluations by (function get_diag_sums (board) (list (sum (get_diag1 board)) (sum (get_diag2 board))))
problem get_magic_number ...
problem get_magic_number solved after 12 evaluations by (function get_magic_number (board) (get_magic_number_n (len board)))

Solving problems, layer 3 ...
problem get_sums_magic_square ...
problem get_sums_magic_square solved after 1318 evaluations by (function get_sums_magic_square (board) (add (get_row_sums board) (add (get_col_sums board) (get_diag_sums board))))

Solving problems, layer 4 ...
problem is_magic_square ...
problem is_magic_square solved after 3 evaluations by (function is_magic_square (board) (are_all_equal_to (get_sums_magic_square board) board))
total execution time 123 seconds total evaluations 164873
